...
option.forEach((item)=>{
    item.addEventListener("click",()=>{
        ...
        options.classList.remove("active-options"); // Close the dropdown
...
let Api_url= "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=AIzaSyCZzOUg5C7YL3bJgU0M_litQLza6Nbi0VA"
...
if(message.includes("open") && message.includes("chatbot")){
  speak("Okay, here it is")
...
}else if(message.includes("how are you")||message.includes("hey")){
  speak("i am good. How are you doing?")
}else if(message.includes("who are you")){
  speak("i am virtual assistant for this website")
...
speak(time)
  ...
  speak(finalText)
  window.open(`https://www.google.com/search?q=${message.replace("Anthony","")}`,"_blank")
}
}
